...
contract HelperConfig is Script {
    ...
    // we put this constructor of raffle in the HELPER CONFIG, because a lot
    // of these are going to be dependend on the chain we are going to be using
    // and therefore no matter what chain we deploy on we have already set this up and we will not have any problem
